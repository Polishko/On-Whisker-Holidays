...
- The main app - hotel list layout design and homepage layout as well as ideas on using the map and the weather API are based on samples from Jonas Schmedtmann's Ultimate React Course in Udemy.
