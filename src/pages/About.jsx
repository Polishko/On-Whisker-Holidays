        ...
        <div className={styles.mainShape}>
          <div className={styles.text}>
            ...
            <p>
              ...
              someone else&apos;s care, and the idea for this site was born
              during our search for accommodation options that allow traveling
              with animal friends.
            </p>
            <p>
              We hope all humans who share their lives with animal companions
              find this site helpful and discover holiday ideas suitable for
              their own needs.
